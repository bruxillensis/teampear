...
const int pubProfessor::getNumberOfBookChapters()							{ return this->numberOfBookChapters; }
const int pubProfessor::getNumberOfBooks()								{ return this->numberOfBooks; }
const int pubProfessor::getNumberOfBookEdits()							{ return this->numberOfBookEdits; }
const int pubProfessor::getNumberOfCaseReports()							{ return this->numberOfCaseReports; }
const int pubProfessor::getNumberOfClinicalCareGuides()					{ return this->numberOfClinicalCareGuides; }
const int pubProfessor::getNumberOfCommentaries()							{ return this->numberOfCommentaries; }
const int pubProfessor::getNumberOfConferences()							{ return this->numberOfConferences; }
const int pubProfessor::getNumberOfEditorials()							{ return this->numberOfEditorials; }
const int pubProfessor::getNumberOfInvitedArticles()						{ return this->numberOfInvitedArticles; }
const int pubProfessor::getNumberOfJournalArticles()						{ return this->numberOfJournalArticles; }
const int pubProfessor::getNumberOfLetters()								{ return this->numberOfLetters; }
const int pubProfessor::getNumberOfMagazine()								{ return this->numberOfMagazine; }
const int pubProfessor::getNumberOfManuals()								{ return this->numberOfManuals; }
const int pubProfessor::getNumberOfMonographs()							{ return this->numberOfMonographs; }
const int pubProfessor::getNumberOfMultimedia()							{ return this->numberOfMultimedia; }
const int pubProfessor::getNumberOfNewsletterArticles()					{ return this->numberOfNewsletterArticles; }
const int pubProfessor::getNumberOfNewspaperArticles()					{ return this->numberOfNewspaperArticles; }
const int pubProfessor::getNumberOfAbstracts()							{ return this->numberOfAbstracts; }
const int pubProfessor::getNumberOfStudentPubs()							{ return this->numberOfStudentPubs; }
const int pubProfessor::getNumberOfWebVids()								{ return this->numberOfWebVids; }
const int pubProfessor::getNumberOfWorkingPapers()						{ return this->numberOfWorkingPapers; }
